 ...
 * @description
 */
public class BaseController<Bs extends BaseService, Entity extends BaseModel> {
    ...
    public Rb<IPage<Entity>> page(@RequestBody LegaPage page) throws IllegalAccessException, InstantiationException {
